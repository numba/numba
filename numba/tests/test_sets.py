...
class TestSets(BaseTest):
    ...
    def test_linear_probing_application(self):
        # NOTE: these two examples are somewhat contrived, they are necessarily
        # generating "unusual" states for testing purposes.
        # See issue #6543 for details.
        ...
        def baz():
            ...
            return (3, 4) in openSet
        
        self.assertFalse(baz())
