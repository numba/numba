...
class CSACallConv(CPUCallConv):
#class CSACallConv(MinimalCallConv):
    pass

#class CSACallConv(BaseCallConv):
#    """
#    The calling convention for CSA targets.
#    The implemented function signature is:
#
...
#        print("call_function", is_generator_function)
#        print("retty", retty)
#        print("retvaltmp", retvaltmp)
