...
def _implement_integer_operators():
    ...
    register(implement(operator.floordiv, ty, ty)(builtins.int_floordiv_impl))
    register(implement(operator.ifloordiv, ty, ty)(builtins.int_floordiv_impl))
    register(implement(operator.mod, ty, ty)(builtins.int_rem_impl))
    register(implement(operator.imod, ty, ty)(builtins.int_rem_impl))
    register(implement(operator.eq, ty, ty)(builtins.int_eq_impl))
    register(implement(operator.ne, ty, ty)(builtins.int_ne_impl))
    register(implement(operator.pow, ty, ty)(builtins.int_power_impl))
    register(implement(operator.ipow, ty, ty)(builtins.int_power_impl))
    ...
    for ty in types.unsigned_domain:
        ...
        register(implement(operator.rshift, ty, types.uintp)(builtins.int_lshr_impl))
        register(implement(operator.irshift, ty, types.uintp)(builtins.int_lshr_impl))
    ...
    for ty in types.signed_domain:
        ...
        register(implement(operator.pow, types.float64, ty)(builtins.int_power_impl))
        register(implement(operator.ipow, types.float64, ty)(builtins.int_power_impl))
        register(implement(operator.rshift, ty, types.uintp)(builtins.int_ashr_impl))
        register(implement(operator.irshift, ty, types.uintp)(builtins.int_ashr_impl))
