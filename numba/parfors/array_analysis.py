...
class ArrayAnalysis(object):
    ...
    def _insert_runtime_broadcast_call(self, scope, loc, arrs, max_dim):
        ...
        max_dim_var = scope.redefine("max_dim", loc)
