...
def wrap_index(typingctx, idx, size):
    ...
    # of the originals.
    unified_ty = types.scalars.Integer("%sint%d" %
                                ("" if size.signed else "u", unified_bitwidth),
                                bitwidth=unified_bitwidth,
                                signed=size.signed)
    idx_unified = types.scalars.Integer("%sint%d" %
                                ("" if idx.signed else "u", unified_bitwidth),
                                bitwidth=unified_bitwidth,
                                signed=idx.signed)
