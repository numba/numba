...
utility_funcs = list(object_to_numeric.itervalues()) + [
    ...
    UtilityFunction.load("primitive2pydatetime",
        object_(long_, int_, int_, int_, int_, int_)),
    UtilityFunction.load("primitive2numpydatetime",
        object_(long_, int_, int_, int_, int_, int_, object_)),
    ...
    UtilityFunction.load("numpydatetime2year", long_(object_)),
    UtilityFunction.load("numpydatetime2month", int_(object_)),
    UtilityFunction.load("numpydatetime2day", int_(object_)),
