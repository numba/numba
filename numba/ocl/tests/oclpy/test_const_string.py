...
class TestOclConstString(unittest.TestCase):
    def test_const_string(self):
        # These imports is incompatible with OCLSIM
        from numba.ocl.descriptor import OCLTargetDesc
        from numba.ocl.ocldrv.nvvm import llvm_to_ptx, ADDRSPACE_CONSTANT
