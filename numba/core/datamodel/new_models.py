...
class MachineBooleanModel(DataModel):
    _bit_type = ir.IntType(1)
    _byte_type = ir.IntType(8)
...
class MachineIntegerModel(PrimitiveModel):
    def __init__(self, dmm, fe_type):
        be_type = ir.IntType(fe_type.bitwidth)
        super(MachineIntegerModel, self).__init__(dmm, fe_type, be_type)


@register_default(types.MachineFloat)
class MachineFloatModel(PrimitiveModel):
    def __init__(self, dmm, fe_type):
        if fe_type.bitwidth <= 32:
            be_type = ir.FloatType()
        elif fe_type.bitwidth <= 64:
            ...
            raise NotImplementedError(fe_type)
        super(MachineFloatModel, self).__init__(dmm, fe_type, be_type)


@register_default(types.MachineComplex)
class MachineComplexModel(ComplexModel):
    _element_type = NotImplemented
    ...
    def __init__(self, dmm, fe_type):
        ...
        super(MachineComplexModel, self).__init__(dmm, fe_type, members)
