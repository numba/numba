...
class _OverloadWrapper(object):
    ...
    def _stub_generator(self, body_func, varnames_gen):
        ...
        additional_var_names = [*varnames_gen]
        new_varnames.extend(additional_var_names)
        co_argcount = len(new_varnames)
        co_args = [co_argcount]
        additional_co_nlocals = len(additional_var_names)
