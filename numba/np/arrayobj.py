...
def _as_layout_array_intrinsic(typingctx, a, output_layout):
    ...
    layout_val = output_layout.literal_value
    # Always mark result as writable - copies are writable
    ret = a.copy(layout=layout_val, ndim=max(a.ndim, 1), readonly=False)
    sig = ret(a, output_layout)

    return sig, lambda c, b, s, a: _as_layout_array(
        c, b, s, a, output_layout=layout_val)
