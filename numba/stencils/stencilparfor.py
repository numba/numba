    ...
    def _mk_stencil_parfor(self, label, in_args, out_arr, stencil_ir,
        ...
        if out_arr is None:
            ...
            dtype_attr_assign = ir.Assign(
                dtype_np_attr_call, dtype_attr_var, loc)
            ...
            zero_index_var = ir.Var(
                scope, mk_unique_var("$zero_index_var"), loc)
            ...
            slice_func_var = ir.Var(
                scope, mk_unique_var("$slice_func_var"), loc)
            ...
            def handle_border(slice_fn_ty,
                ...
                slice_callexpr = ir.Expr.call(
                    func=slice_func_var,
                    args=(other_arg, si_var) if other_first else (
                        si_var, other_arg),
                    kws=(),
                    loc=loc)
                self.calltypes[slice_callexpr] = sig
                ...
                setitem_call = ir.SetItem(
                    out_arr, border_ind_var, zero_var, loc)
