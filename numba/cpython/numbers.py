...
def int_sub_impl(context, builder, sig, args, loc):
    [va, vb] = args
    [ta, tb] = sig.args
    a = context.cast(builder, va, ta, sig.return_type, loc)
    b = context.cast(builder, vb, tb, sig.return_type, loc)
...
def complex_to_complex(context, builder, fromty, toty, val, loc=None):
    ...
    dst.real = context.cast(builder, src.real, srcty, dstty, loc=None)
    dst.imag = context.cast(builder, src.imag, srcty, dstty, loc=None)
