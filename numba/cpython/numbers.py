...
glue_lowering(operator.ge, types.boolean, types.boolean)(int_uge_impl)
...
def _implement_integer_operators():
    ...
    for ty in types.unsigned_domain:
        glue_lowering(operator.lt, ty, ty)(int_ult_impl)
        glue_lowering(operator.le, ty, ty)(int_ule_impl)
        glue_lowering(operator.gt, ty, ty)(int_ugt_impl)
        glue_lowering(operator.ge, ty, ty)(int_uge_impl)
    ...
    glue_lowering(operator.lt, types.IntegerLiteral, types.IntegerLiteral)(int_slt_impl)
    glue_lowering(operator.gt, types.IntegerLiteral, types.IntegerLiteral)(int_slt_impl)
    glue_lowering(operator.le, types.IntegerLiteral, types.IntegerLiteral)(int_slt_impl)
    glue_lowering(operator.ge, types.IntegerLiteral, types.IntegerLiteral)(int_slt_impl)
    for ty in types.signed_domain:
        glue_lowering(operator.lt, ty, ty)(int_slt_impl)
        glue_lowering(operator.le, ty, ty)(int_sle_impl)
        glue_lowering(operator.gt, ty, ty)(int_sgt_impl)
        glue_lowering(operator.ge, ty, ty)(int_sge_impl)
        glue_lowering(operator.pow, types.Float, ty)(int_power_impl)
        glue_lowering(operator.ipow, types.Float, ty)(int_power_impl)
        glue_lowering(pow, types.Float, ty)(int_power_impl)
...
def _implement_bitwise_operators():
    for ty in (types.Boolean, types.Integer):
        glue_lowering(operator.and_, ty, ty)(int_and_impl)
        glue_lowering(operator.iand, ty, ty)(int_and_impl)
        glue_lowering(operator.or_, ty, ty)(int_or_impl)
        glue_lowering(operator.ior, ty, ty)(int_or_impl)
        glue_lowering(operator.xor, ty, ty)(int_xor_impl)
        glue_lowering(operator.ixor, ty, ty)(int_xor_impl)

        glue_lowering(operator.invert, ty)(int_invert_impl)
...
glue_lowering(operator.ge, ty, ty)(real_ge_impl)
