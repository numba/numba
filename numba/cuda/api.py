...
@require_context
def device_array(shape, dtype=np.float32, strides=None, order='C', stream=0):
    """device_array(shape, dtype=np.float32, strides=None, order='C', stream=0)
...
@require_context
def managed_array(shape, dtype=np.float32, strides=None, order='C', stream=0,
                  attach_global=True):
    """managed_array(shape, dtype=np.float32, strides=None, order='C', stream=0,
                     attach_global=True)
...
@require_context
def pinned_array(shape, dtype=np.float32, strides=None, order='C'):
    """pinned_array(shape, dtype=np.float32, strides=None, order='C')
...
@require_context
def mapped_array(shape, dtype=np.float32, strides=None, order='C', stream=0,
                 portable=False, wc=False):
    """mapped_array(shape, dtype=np.float32, strides=None, order='C', stream=0,
                    portable=False, wc=False)
