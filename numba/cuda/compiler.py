...
@global_compiler_lock
def compile_ptx(pyfunc, args, debug=False, fastmath=False, cc=None, opt=3):
    ...
    :param cc: Compute capability to compile for, as a tuple ``(MAJOR, MINOR)``.
               Defaults to ``(5, 0)``.
    :type cc: tuple
    :param opt: Enable (``3``) or disable (``0``) optimizations. Defaults to
                ``3``.
    :type opt: int
    :return: PTX code generated by NVVM.
    :rtype: bytes
    """
