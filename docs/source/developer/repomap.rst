...
- :ghfile:`numba/np/polynomial_class/polynomial_functions.py` - Implementations of NumPy ``Polynomial`` functions
- :ghfile:`numba/np/polynomial_class/polynomial_core.py` - Implementations of NumPy ``Polynomial`` class
