...
* :func:`~numpy.lib.stride_tricks.sliding_window_view` (the *subok*
  argument is not supported, the *writeable* argument is not supported
  with the returned view always being writeable)
