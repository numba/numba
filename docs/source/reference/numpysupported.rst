...
* :func:`numpy.select` (only using homogeneous lists or tuples for the first two arguments (condlist and choicelist). Additionally, these two arguments can only contain arrays (unlike Numpy that also accepts tuples).
* :func:`numpy.shape`
* :func:`numpy.sinc`
